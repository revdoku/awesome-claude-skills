...
- [Revdoku](https://github.com/revdoku/revdoku/tree/main/skills/revdoku) - Store private files, share versions, and read incoming email and attachments in buckets with their own email addresses.
