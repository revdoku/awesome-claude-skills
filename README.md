...
- [Revdoku](./revdoku/) - Store private files, share versions, and read incoming email and attachments in buckets with their own email addresses. By [Revdoku](https://github.com/revdoku/revdoku).
